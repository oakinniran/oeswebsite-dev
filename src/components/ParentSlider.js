...
import { sliderData } from "./data/slider-dataparent.js";
      ...
      <TawkMessengerReact
       ...
       <Modal show={showModal} onHide={handleClose} className="alert" >
        ...
        { sliderData.map((slide, index) => {
            return (
              <a href="https://applications.oes.com.ng/OESWebApp/register.do" ><div className={index === currentSlide ? "slide current" : "slide" } key={index}>
                    {index === currentSlide && ( 
                        <>
